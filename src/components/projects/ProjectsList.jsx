    ...
    const projects = [
        {
            ...
            date: "August 2025",
            imageUrl: "/projects/raspberry.jpg",
            description: "A simple code to scan barcodes and send an HTTP request, using a raspberry pi zero 2 W and a barcode scanner",
            buttons: {
                github: {
                    link: "https://github.com/Lughx/TLB-scanner"
                }
            },
            technologies: [
                {
        ...
        },
        {
            ...
            title: "Urpet",
            date: "April 2024",
            imageUrl: "/projects/urpet.webp",
            description: "Urpet is a web application which allows you to find a place to leave your pet when you go on a trip, whether it’s a hospital, a trusted person, or a certified place",
            buttons: {
            },
            technologies: [
                {
        ...
        },
        {
            ...
            description: "Web portfolio to showcase developer information, along with their projects",
            buttons: {
                github: {
                    link: "https://github.com/Lughx/yats"
                },
                web: {
                    link: "https://yats.dev"
                }
        ...
        },
        {
            ...
            title: "Partify",
            date: "March 2024",
            imageUrl: "/projects/partify.webp",
            description: "Partify is a website to manage events, allowing the selection of place, services, entertainers, etc. This website was created while doing an internship at Urbrand",
            buttons: {
            },
            technologies: [
                {
        ...
        },
        {
            ...
            description: "Paladinslx is a platform that facilitates access to player statistics for the video game Paladins",
            buttons: {
                github: {
                    link: "https://github.com/Lughx/Paladinslx-frontend"
                },
                web: {
        ...
        },
        {
            ...
            description: "Formula 1 car simulator that drives at the speed limit through a street generated by a given function",
            buttons: {
                github: {
                    link: "https://github.com/Lughx/Matlab-F1"
                }
            },
            technologies: [
                {
        ...
        },
        {
            ...
            buttons: {
                github: {
                    link: "https://github.com/Lughx/Alphabet"
                },
                web: {
                    link: "https://alphabet.yats.dev"
                }
            },
            technologies: [
                {
        ...
        },
        {
            ...
            description: "Simulator of volcanic projectiles that uses angle and speed. Created with Python and Matlab",
            buttons: {
                github: {
                    link: "https://github.com/Lughx/Matlab-volcano"
                }
            },
            technologies: [
                {
        ...
        },
        {
            ...
            description: "Sillogystic is a logic game to train cognitive abilities through questions",
            buttons: {
                github: {
                    link: "https://github.com/Lughx/Syllogistic"
                }
            },
            technologies: [
                {
        ...
        },
        {
            ...
            description: "Website for the school Preparatoria Activo 2030 Albert Einstein with the purpose of providing information about the institution and making data search easier",
            buttons: {
                github: {
                    link: "https://github.com/Lughx/Prepa-frontend"
                }
            },
            technologies: [
                {
        ...
        },
        {
            ...
            description: "Videogame in Unity which involved survival against waves of enemiesz",
            buttons: {
                download: {
